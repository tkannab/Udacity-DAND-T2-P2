...
- To download the dataset documentation, please click [here](https://docs.google.com/spreadsheets/d/1gDyi_L4UvIrLTEC6Wri5nbaMmkGmLQBk-Yx3z0XDEtI/edit#gid=0) 

- To download the dataset, please click [here](https://s3.amazonaws.com/udacity-hosted-downloads/ud651/prosperLoanData.csv).

- To view the code, please click [here](https://github.com/tkannab/Udacity-DAND-T2-P2-EDA/blob/master/Loan%20Dataset%20EDA.rmd)
...
loan_updated$DelinquentList <-  ifelse( loan_updated$LoanStatus == "Chargedoff" | 
                                        ...
                                        loan_updated$LoanStatus == "Past Due (16-30 days)" |
...
```{r include=FALSE}
write.table(loan_updated, file = "prosperLoanData_cleaned.csv",row.names=FALSE, na="",sep=",")
```
